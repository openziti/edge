...
/*HealthCheckOK Base empty response
...
func (o *HealthCheckOK) WithPayload(payload *rest_model.Empty) *HealthCheckOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the health check o k response
func (o *HealthCheckOK) SetPayload(payload *rest_model.Empty) {
	o.Payload = payload
}

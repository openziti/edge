...
func (m *ConfigTypeDetail) validateLinks(formats strfmt.Registry) error {
...
func (m *ConfigTypeDetail) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *ConfigTypeDetail) validateID(formats strfmt.Registry) error {
...
func (m *ConfigTypeDetail) validateUpdatedAt(formats strfmt.Registry) error {

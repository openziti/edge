...
type DetailTransitRouterEnvelope struct {
	...
	// data
	Data *TransitRouterDetail `json:"data,omitempty"`
...
func (m *DetailTransitRouterEnvelope) validateData(formats strfmt.Registry) error {
...
func (m *DetailTransitRouterEnvelope) validateMeta(formats strfmt.Registry) error {
...
func (m *DetailTransitRouterEnvelope) UnmarshalBinary(b []byte) error {
	var res DetailTransitRouterEnvelope

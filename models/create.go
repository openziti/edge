...
func (m *Create) validateData(formats strfmt.Registry) error {
...
func (m *CreateData) validateLinks(formats strfmt.Registry) error {
	...
	if err := m.Links.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("data" + "." + "_links")
		}
		return err
	}

...
//go:generate swagger generate server --target ../../edge --name ZitiEdge --spec ../specs/swagger.yml --model-package rest_model --server-package rest_server --principal interface{} --exclude-main
...
func configureAPI(api *operations.ZitiEdgeAPI) http.Handler {
	...
	if api.EnrollEnrollOtfHandler == nil {
		api.EnrollEnrollOtfHandler = enroll.EnrollOtfHandlerFunc(func(params enroll.EnrollOtfParams) middleware.Responder {
			return middleware.NotImplemented("operation enroll.EnrollOtf has not yet been implemented")
		})
	}
	...
	if api.GeoRegionListGeoRegionsHandler == nil {
		api.GeoRegionListGeoRegionsHandler = geo_region.ListGeoRegionsHandlerFunc(func(params geo_region.ListGeoRegionsParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation geo_region.ListGeoRegions has not yet been implemented")
		})
	}

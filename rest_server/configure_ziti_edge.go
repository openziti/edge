...
import (
	...
	"github.com/netfoundry/ziti-edge/rest_server/operations"
	...
	"github.com/netfoundry/ziti-edge/rest_server/operations/edge_router_policy"
	"github.com/netfoundry/ziti-edge/rest_server/operations/enroll"
	"github.com/netfoundry/ziti-edge/rest_server/operations/enrollment"
	...
	"github.com/netfoundry/ziti-edge/rest_server/operations/session"
	"github.com/netfoundry/ziti-edge/rest_server/operations/terminator"
	"github.com/netfoundry/ziti-edge/rest_server/operations/transit_router"
...
func configureAPI(api *operations.ZitiEdgeAPI) http.Handler {
	...
	if api.CAGetCasIDJwtHandler == nil {
		api.CAGetCasIDJwtHandler = ca.GetCasIDJwtHandlerFunc(func(params ca.GetCasIDJwtParams, principal interface{}) middleware.Responder {
	...
	if api.CAPostCasIDVerifyHandler == nil {
		api.CAPostCasIDVerifyHandler = ca.PostCasIDVerifyHandlerFunc(func(params ca.PostCasIDVerifyParams, principal interface{}) middleware.Responder {
	...
	if api.EnrollPostEnrollCAHandler == nil {
		api.EnrollPostEnrollCAHandler = enroll.PostEnrollCAHandlerFunc(func(params enroll.PostEnrollCAParams) middleware.Responder {
			return middleware.NotImplemented("operation enroll.PostEnrollCA has not yet been implemented")
		})
	}
	if api.EnrollPostEnrollErottHandler == nil {
		api.EnrollPostEnrollErottHandler = enroll.PostEnrollErottHandlerFunc(func(params enroll.PostEnrollErottParams) middleware.Responder {
			return middleware.NotImplemented("operation enroll.PostEnrollErott has not yet been implemented")
		})
	}
	if api.EnrollPostEnrollOttHandler == nil {
		api.EnrollPostEnrollOttHandler = enroll.PostEnrollOttHandlerFunc(func(params enroll.PostEnrollOttParams) middleware.Responder {
			return middleware.NotImplemented("operation enroll.PostEnrollOtt has not yet been implemented")
		})
	}
	if api.EnrollPostEnrollOttcaHandler == nil {
		api.EnrollPostEnrollOttcaHandler = enroll.PostEnrollOttcaHandlerFunc(func(params enroll.PostEnrollOttcaParams) middleware.Responder {
			return middleware.NotImplemented("operation enroll.PostEnrollOttca has not yet been implemented")
		})
	}
	if api.EnrollPostEnrollUpdbHandler == nil {
		api.EnrollPostEnrollUpdbHandler = enroll.PostEnrollUpdbHandlerFunc(func(params enroll.PostEnrollUpdbParams) middleware.Responder {
			return middleware.NotImplemented("operation enroll.PostEnrollUpdb has not yet been implemented")
		})
	}
	...
	if api.CACreateCAHandler == nil {
		api.CACreateCAHandler = ca.CreateCAHandlerFunc(func(params ca.CreateCAParams, principal interface{}) middleware.Responder {
	...
	if api.CADeleteCAHandler == nil {
		api.CADeleteCAHandler = ca.DeleteCAHandlerFunc(func(params ca.DeleteCAParams, principal interface{}) middleware.Responder {
	...
	if api.TransitRouterDeleteTransitRouterHandler == nil {
		api.TransitRouterDeleteTransitRouterHandler = transit_router.DeleteTransitRouterHandlerFunc(func(params transit_router.DeleteTransitRouterParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation transit_router.DeleteTransitRouter has not yet been implemented")
		})
	}
	...
	if api.CADetailCAHandler == nil {
		api.CADetailCAHandler = ca.DetailCAHandlerFunc(func(params ca.DetailCAParams, principal interface{}) middleware.Responder {
	...
	if api.GeoRegionDetailGeoRegionHandler == nil {
		api.GeoRegionDetailGeoRegionHandler = geo_region.DetailGeoRegionHandlerFunc(func(params geo_region.DetailGeoRegionParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation geo_region.DetailGeoRegion has not yet been implemented")
		})
	}
	...
	if api.TransitRouterDetailTransitRouterHandler == nil {
		api.TransitRouterDetailTransitRouterHandler = transit_router.DetailTransitRouterHandlerFunc(func(params transit_router.DetailTransitRouterParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation transit_router.DetailTransitRouter has not yet been implemented")
		})
	}
	...
	if api.CAListCAHandler == nil {
		api.CAListCAHandler = ca.ListCAHandlerFunc(func(params ca.ListCAParams, principal interface{}) middleware.Responder {
	...
	if api.GeoRegionListGeoRegionHandler == nil {
		api.GeoRegionListGeoRegionHandler = geo_region.ListGeoRegionHandlerFunc(func(params geo_region.ListGeoRegionParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation geo_region.ListGeoRegion has not yet been implemented")
		})
	}
	...
	if api.TransitRouterListTransitRoutersHandler == nil {
		api.TransitRouterListTransitRoutersHandler = transit_router.ListTransitRoutersHandlerFunc(func(params transit_router.ListTransitRoutersParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation transit_router.ListTransitRouters has not yet been implemented")
		})
	}
	...
	if api.CAPatchCAHandler == nil {
		api.CAPatchCAHandler = ca.PatchCAHandlerFunc(func(params ca.PatchCAParams, principal interface{}) middleware.Responder {
	...
	if api.TransitRouterPatchTransitRouterHandler == nil {
		api.TransitRouterPatchTransitRouterHandler = transit_router.PatchTransitRouterHandlerFunc(func(params transit_router.PatchTransitRouterParams, principal interface{}) middleware.Responder {
	...
	if api.CAUpdateCAHandler == nil {
		api.CAUpdateCAHandler = ca.UpdateCAHandlerFunc(func(params ca.UpdateCAParams, principal interface{}) middleware.Responder {

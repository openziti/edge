...
func (o *ListEdgeRouterIdentitiesOK) WithPayload(payload *models.ListIdentitiesEnvelope) *ListEdgeRouterIdentitiesOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list edge router identities o k response
func (o *ListEdgeRouterIdentitiesOK) SetPayload(payload *models.ListIdentitiesEnvelope) {
	o.Payload = payload
}
...
func (o *ListEdgeRouterIdentitiesUnauthorized) WithPayload(payload *models.APIErrorEnvelope) *ListEdgeRouterIdentitiesUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list edge router identities unauthorized response
func (o *ListEdgeRouterIdentitiesUnauthorized) SetPayload(payload *models.APIErrorEnvelope) {
	o.Payload = payload
}
...
func (o *ListEdgeRouterIdentitiesNotFound) WithPayload(payload *models.APIErrorEnvelope) *ListEdgeRouterIdentitiesNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list edge router identities not found response
func (o *ListEdgeRouterIdentitiesNotFound) SetPayload(payload *models.APIErrorEnvelope) {
	o.Payload = payload
}

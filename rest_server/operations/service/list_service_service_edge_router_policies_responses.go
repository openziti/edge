...
type ListServiceServiceEdgeRouterPoliciesOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.ListServiceEdgeRouterPoliciesEnvelope `json:"body,omitempty"`
}
...
func (o *ListServiceServiceEdgeRouterPoliciesOK) WithPayload(payload *models.ListServiceEdgeRouterPoliciesEnvelope) *ListServiceServiceEdgeRouterPoliciesOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list service service edge router policies o k response
func (o *ListServiceServiceEdgeRouterPoliciesOK) SetPayload(payload *models.ListServiceEdgeRouterPoliciesEnvelope) {
	o.Payload = payload
}
...
func (o *ListServiceServiceEdgeRouterPoliciesUnauthorized) WithPayload(payload *models.APIErrorEnvelope) *ListServiceServiceEdgeRouterPoliciesUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list service service edge router policies unauthorized response
func (o *ListServiceServiceEdgeRouterPoliciesUnauthorized) SetPayload(payload *models.APIErrorEnvelope) {
	o.Payload = payload
}

...
func NewZitiEdgeAPI(spec *loads.Document) *ZitiEdgeAPI {
	return &ZitiEdgeAPI{
		...
		EnrollEnrollOtfHandler: enroll.EnrollOtfHandlerFunc(func(params enroll.EnrollOtfParams) middleware.Responder {
		...
		GeoRegionListGeoRegionsHandler: geo_region.ListGeoRegionsHandlerFunc(func(params geo_region.ListGeoRegionsParams, principal interface{}) middleware.Responder {
...
type ZitiEdgeAPI struct {
	...
	// EnrollEnrollOtfHandler sets the operation handler for the enroll otf operation
	EnrollEnrollOtfHandler enroll.EnrollOtfHandler
...
func (o *ZitiEdgeAPI) Validate() error {
	...
	if o.EnrollEnrollOtfHandler == nil {
		unregistered = append(unregistered, "enroll.EnrollOtfHandler")
	}
	...
	if o.GeoRegionListGeoRegionsHandler == nil {
		unregistered = append(unregistered, "geo_region.ListGeoRegionsHandler")
	}
...
func (o *ZitiEdgeAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/enroll/otf"] = enroll.NewEnrollOtf(o.context, o.EnrollEnrollOtfHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/geo-regions"] = geo_region.NewListGeoRegions(o.context, o.GeoRegionListGeoRegionsHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}

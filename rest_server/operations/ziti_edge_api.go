...
func NewZitiEdgeAPI(spec *loads.Document) *ZitiEdgeAPI {
	return &ZitiEdgeAPI{
		...
		CertificateAuthorityPostCasIDVerifyHandler: certificate_authority.PostCasIDVerifyHandlerFunc(func(params certificate_authority.PostCasIDVerifyParams, principal interface{}) middleware.Responder {
		...
		EdgeRouterListEdgeRouterServicePoliciesHandler: edge_router.ListEdgeRouterServicePoliciesHandlerFunc(func(params edge_router.ListEdgeRouterServicePoliciesParams, principal interface{}) middleware.Responder {
...
type ZitiEdgeAPI struct {
	...
	// CertificateAuthorityPostCasIDVerifyHandler sets the operation handler for the post cas ID verify operation
	CertificateAuthorityPostCasIDVerifyHandler certificate_authority.PostCasIDVerifyHandler
	...
	// EdgeRouterListEdgeRouterServicePoliciesHandler sets the operation handler for the list edge router service policies operation
	EdgeRouterListEdgeRouterServicePoliciesHandler edge_router.ListEdgeRouterServicePoliciesHandler
...
func (o *ZitiEdgeAPI) Validate() error {
	...
	if o.CertificateAuthorityPostCasIDVerifyHandler == nil {
		unregistered = append(unregistered, "certificate_authority.PostCasIDVerifyHandler")
	}
	...
	if o.EdgeRouterListEdgeRouterServicePoliciesHandler == nil {
		unregistered = append(unregistered, "edge_router.ListEdgeRouterServicePoliciesHandler")
	}
...
func (o *ZitiEdgeAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/cas/{id}/jwt"] = certificate_authority.NewGetCasIDJwt(o.context, o.CertificateAuthorityGetCasIDJwtHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["POST"]["/cas/{id}/verify"] = certificate_authority.NewPostCasIDVerify(o.context, o.CertificateAuthorityPostCasIDVerifyHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/edge-routers/{id}/service-edge-router-policies"] = edge_router.NewListEdgeRouterServicePolicies(o.context, o.EdgeRouterListEdgeRouterServicePoliciesHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}

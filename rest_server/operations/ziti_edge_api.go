...
func NewZitiEdgeAPI(spec *loads.Document) *ZitiEdgeAPI {
	return &ZitiEdgeAPI{
		...
		EnrollPostEnrollOttHandler: enroll.PostEnrollOttHandlerFunc(func(params enroll.PostEnrollOttParams) middleware.Responder {
			return middleware.NotImplemented("operation enroll.PostEnrollOtt has not yet been implemented")
		}),
		EnrollPostEnrollOttcaHandler: enroll.PostEnrollOttcaHandlerFunc(func(params enroll.PostEnrollOttcaParams) middleware.Responder {
			return middleware.NotImplemented("operation enroll.PostEnrollOttca has not yet been implemented")
		}),
		EnrollPostEnrollUpdbHandler: enroll.PostEnrollUpdbHandlerFunc(func(params enroll.PostEnrollUpdbParams) middleware.Responder {
		...
		TransitRouterDeleteTransitRouterHandler: transit_router.DeleteTransitRouterHandlerFunc(func(params transit_router.DeleteTransitRouterParams, principal interface{}) middleware.Responder {
		...
		GeoRegionDetailGeoRegionHandler: geo_region.DetailGeoRegionHandlerFunc(func(params geo_region.DetailGeoRegionParams, principal interface{}) middleware.Responder {
		...
		TransitRouterDetailTransitRouterHandler: transit_router.DetailTransitRouterHandlerFunc(func(params transit_router.DetailTransitRouterParams, principal interface{}) middleware.Responder {
		...
		EdgeRouterLisgEdgeRoutersHandler: edge_router.LisgEdgeRoutersHandlerFunc(func(params edge_router.LisgEdgeRoutersParams, principal interface{}) middleware.Responder {
		...
		ConfigListConfigTypeHandler: config.ListConfigTypeHandlerFunc(func(params config.ListConfigTypeParams, principal interface{}) middleware.Responder {
		...
		EdgeRouterListEdgeRoutersEdgeRouterPoliciesHandler: edge_router.ListEdgeRoutersEdgeRouterPoliciesHandlerFunc(func(params edge_router.ListEdgeRoutersEdgeRouterPoliciesParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation edge_router.ListEdgeRoutersEdgeRouterPolicies has not yet been implemented")
		}),
		EdgeRouterListEdgeRoutersServicePoliciesHandler: edge_router.ListEdgeRoutersServicePoliciesHandlerFunc(func(params edge_router.ListEdgeRoutersServicePoliciesParams, principal interface{}) middleware.Responder {
		...
		GeoRegionListGeoRegionHandler: geo_region.ListGeoRegionHandlerFunc(func(params geo_region.ListGeoRegionParams, principal interface{}) middleware.Responder {
		...
		IdentityListIdentityTypeHandler: identity.ListIdentityTypeHandlerFunc(func(params identity.ListIdentityTypeParams, principal interface{}) middleware.Responder {
		...
		TransitRouterListTransitRoutersHandler: transit_router.ListTransitRoutersHandlerFunc(func(params transit_router.ListTransitRoutersParams, principal interface{}) middleware.Responder {
		...
		TransitRouterUpdateTransitRouterHandler: transit_router.UpdateTransitRouterHandlerFunc(func(params transit_router.UpdateTransitRouterParams, principal interface{}) middleware.Responder {
...
type ZitiEdgeAPI struct {
	...
	EnrollPostEnrollOttHandler enroll.PostEnrollOttHandler
	// EnrollPostEnrollOttcaHandler sets the operation handler for the post enroll ottca operation
	EnrollPostEnrollOttcaHandler enroll.PostEnrollOttcaHandler
	// EnrollPostEnrollUpdbHandler sets the operation handler for the post enroll updb operation
	EnrollPostEnrollUpdbHandler enroll.PostEnrollUpdbHandler
	...
	// EdgeRouterLisgEdgeRoutersHandler sets the operation handler for the lisg edge routers operation
	EdgeRouterLisgEdgeRoutersHandler edge_router.LisgEdgeRoutersHandler
	...
	ConfigListConfigTypeHandler config.ListConfigTypeHandler
	...
	// EdgeRouterListEdgeRoutersEdgeRouterPoliciesHandler sets the operation handler for the list edge routers edge router policies operation
	EdgeRouterListEdgeRoutersEdgeRouterPoliciesHandler edge_router.ListEdgeRoutersEdgeRouterPoliciesHandler
	// EdgeRouterListEdgeRoutersServicePoliciesHandler sets the operation handler for the list edge routers service policies operation
	EdgeRouterListEdgeRoutersServicePoliciesHandler edge_router.ListEdgeRoutersServicePoliciesHandler
	...
	// GeoRegionListGeoRegionHandler sets the operation handler for the list geo region operation
	GeoRegionListGeoRegionHandler geo_region.ListGeoRegionHandler
	...
	// IdentityListIdentityTypeHandler sets the operation handler for the list identity type operation
	IdentityListIdentityTypeHandler identity.ListIdentityTypeHandler
...
func (o *ZitiEdgeAPI) Validate() error {
	...
	if o.EnrollPostEnrollOttHandler == nil {
		unregistered = append(unregistered, "enroll.PostEnrollOttHandler")
	}
	if o.EnrollPostEnrollOttcaHandler == nil {
		unregistered = append(unregistered, "enroll.PostEnrollOttcaHandler")
	}
	if o.EnrollPostEnrollUpdbHandler == nil {
		unregistered = append(unregistered, "enroll.PostEnrollUpdbHandler")
	}
	...
	if o.TransitRouterDeleteTransitRouterHandler == nil {
		unregistered = append(unregistered, "transit_router.DeleteTransitRouterHandler")
	}
	...
	if o.GeoRegionDetailGeoRegionHandler == nil {
		unregistered = append(unregistered, "geo_region.DetailGeoRegionHandler")
	}
	...
	if o.TransitRouterDetailTransitRouterHandler == nil {
		unregistered = append(unregistered, "transit_router.DetailTransitRouterHandler")
	}
	...
	if o.EdgeRouterLisgEdgeRoutersHandler == nil {
		unregistered = append(unregistered, "edge_router.LisgEdgeRoutersHandler")
	}
	...
	if o.ConfigListConfigTypeHandler == nil {
		unregistered = append(unregistered, "config.ListConfigTypeHandler")
	}
	...
	if o.EdgeRouterListEdgeRoutersEdgeRouterPoliciesHandler == nil {
		unregistered = append(unregistered, "edge_router.ListEdgeRoutersEdgeRouterPoliciesHandler")
	}
	if o.EdgeRouterListEdgeRoutersServicePoliciesHandler == nil {
		unregistered = append(unregistered, "edge_router.ListEdgeRoutersServicePoliciesHandler")
	}
	if o.EnrollmentListEnrollmentsHandler == nil {
		unregistered = append(unregistered, "enrollment.ListEnrollmentsHandler")
	}
	if o.GeoRegionListGeoRegionHandler == nil {
		unregistered = append(unregistered, "geo_region.ListGeoRegionHandler")
	}
	...
	if o.IdentityListIdentityTypeHandler == nil {
		unregistered = append(unregistered, "identity.ListIdentityTypeHandler")
	}
	...
	if o.TransitRouterListTransitRoutersHandler == nil {
		unregistered = append(unregistered, "transit_router.ListTransitRoutersHandler")
	}
	...
	if o.TransitRouterUpdateTransitRouterHandler == nil {
		unregistered = append(unregistered, "transit_router.UpdateTransitRouterHandler")
	}
...
func (o *ZitiEdgeAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/edge-router-policies/{id}/edge-routers"] = edge_router_policy.NewGetEdgeRouterPoliciesIDEdgeRouters(o.context, o.EdgeRouterPolicyGetEdgeRouterPoliciesIDEdgeRoutersHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/edge-router-policies/{id}/identities"] = edge_router_policy.NewGetEdgeRouterPoliciesIDIdentities(o.context, o.EdgeRouterPolicyGetEdgeRouterPoliciesIDIdentitiesHandler)
	...
	o.handlers["POST"]["/enroll/erott"] = enroll.NewPostEnrollErott(o.context, o.EnrollPostEnrollErottHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/enroll/ott"] = enroll.NewPostEnrollOtt(o.context, o.EnrollPostEnrollOttHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/enroll/ottca"] = enroll.NewPostEnrollOttca(o.context, o.EnrollPostEnrollOttcaHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/enroll/updb"] = enroll.NewPostEnrollUpdb(o.context, o.EnrollPostEnrollUpdbHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	...
	o.handlers["POST"]["/authenticators"] = authenticator.NewCreateAuthenticators(o.context, o.AuthenticatorCreateAuthenticatorsHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	...
	o.handlers["DELETE"]["/transit-routers/{id}"] = transit_router.NewDeleteTransitRouter(o.context, o.TransitRouterDeleteTransitRouterHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/geo-regions/{id}"] = geo_region.NewDetailGeoRegion(o.context, o.GeoRegionDetailGeoRegionHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/transit-routers/{id}"] = transit_router.NewDetailTransitRouter(o.context, o.TransitRouterDetailTransitRouterHandler)
	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/edge-routers"] = edge_router.NewLisgEdgeRouters(o.context, o.EdgeRouterLisgEdgeRoutersHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/configs"] = config.NewListConfig(o.context, o.ConfigListConfigHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/config-types"] = config.NewListConfigType(o.context, o.ConfigListConfigTypeHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/edge-routers/{id}/edge-router-policies"] = edge_router.NewListEdgeRoutersEdgeRouterPolicies(o.context, o.EdgeRouterListEdgeRoutersEdgeRouterPoliciesHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/edge-routers/{id}/service-edge-router-policies"] = edge_router.NewListEdgeRoutersServicePolicies(o.context, o.EdgeRouterListEdgeRoutersServicePoliciesHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/geo-regions"] = geo_region.NewListGeoRegion(o.context, o.GeoRegionListGeoRegionHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/identity-types"] = identity.NewListIdentityType(o.context, o.IdentityListIdentityTypeHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/transit-routers"] = transit_router.NewListTransitRouters(o.context, o.TransitRouterListTransitRoutersHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["PUT"]["/transit-routers/{id}"] = transit_router.NewUpdateTransitRouter(o.context, o.TransitRouterUpdateTransitRouterHandler)
}

...
func (o *ListIdentityRoleAttributesOK) WithPayload(payload *models.ListRoleAttributesEnvelope) *ListIdentityRoleAttributesOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list identity role attributes o k response
func (o *ListIdentityRoleAttributesOK) SetPayload(payload *models.ListRoleAttributesEnvelope) {
	o.Payload = payload
}
...
func (o *ListIdentityRoleAttributesUnauthorized) WithPayload(payload *models.APIErrorEnvelope) *ListIdentityRoleAttributesUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list identity role attributes unauthorized response
func (o *ListIdentityRoleAttributesUnauthorized) SetPayload(payload *models.APIErrorEnvelope) {
	o.Payload = payload
}

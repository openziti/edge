...
// DetailGeoRegionParams contains all the bound params for the detail geo region operation
...
func (o *DetailGeoRegionParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DetailGeoRegionParams) validateID(formats strfmt.Registry) error {

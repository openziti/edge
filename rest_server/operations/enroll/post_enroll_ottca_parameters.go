...
// PostEnrollOttcaParams contains all the bound params for the post enroll ottca operation
// typically these are obtained from a http.Request
//
// swagger:parameters PostEnrollOttca
...
//
// To ensure default values, the struct must have been initialized with NewPostEnrollOttcaParams() beforehand.
func (o *PostEnrollOttcaParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PostEnrollOttcaParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PostEnrollOttcaParams) validateToken(formats strfmt.Registry) error {

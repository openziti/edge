...
// PostEnrollOttParams contains all the bound params for the post enroll ott operation
// typically these are obtained from a http.Request
//
// swagger:parameters PostEnrollOtt
...
//
// To ensure default values, the struct must have been initialized with NewPostEnrollOttParams() beforehand.
func (o *PostEnrollOttParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PostEnrollOttParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PostEnrollOttParams) validateToken(formats strfmt.Registry) error {

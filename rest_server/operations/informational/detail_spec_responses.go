...
type DetailSpecOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.DetailSpecEnvelope `json:"body,omitempty"`
}
...
func (o *DetailSpecOK) WithPayload(payload *models.DetailSpecEnvelope) *DetailSpecOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the detail spec o k response
func (o *DetailSpecOK) SetPayload(payload *models.DetailSpecEnvelope) {
	o.Payload = payload
}

...
func (o *PatchServicePolicyParams) WithBody(body *models.ServicePolicyPatch) *PatchServicePolicyParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the patch service policy params
func (o *PatchServicePolicyParams) SetBody(body *models.ServicePolicyPatch) {
	o.Body = body
}

// WithID adds the id to the patch service policy params
func (o *PatchServicePolicyParams) WithID(id strfmt.UUID) *PatchServicePolicyParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the patch service policy params
func (o *PatchServicePolicyParams) SetID(id strfmt.UUID) {
	o.ID = id
}

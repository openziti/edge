...
import (
	...
	"github.com/netfoundry/ziti-edge/rest_client/ca"
	...
	"github.com/netfoundry/ziti-edge/rest_client/edge_router_policy"
	"github.com/netfoundry/ziti-edge/rest_client/enroll"
	"github.com/netfoundry/ziti-edge/rest_client/enrollment"
	...
	"github.com/netfoundry/ziti-edge/rest_client/session"
	"github.com/netfoundry/ziti-edge/rest_client/terminator"
	"github.com/netfoundry/ziti-edge/rest_client/transit_router"
	"github.com/netfoundry/ziti-edge/rest_client/well_known"
)

// Default ziti edge HTTP client.
...
// NewHTTPClient creates a new ziti edge HTTP client.
func NewHTTPClient(formats strfmt.Registry) *ZitiEdge {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new ziti edge HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *ZitiEdge {
...
// New creates a new ziti edge client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *ZitiEdge {
	// ensure nullable parameters have default
	if formats == nil {
	...
	cli.CA = ca.New(transport, formats)
	...
	cli.TransitRouter = transit_router.New(transport, formats)
...
// ZitiEdge is a client for ziti edge
type ZitiEdge struct {
	...
	GeoRegion geo_region.ClientService
	...
	TransitRouter transit_router.ClientService
...
func (c *ZitiEdge) SetTransport(transport runtime.ClientTransport) {
	...
	c.TransitRouter.SetTransport(transport)

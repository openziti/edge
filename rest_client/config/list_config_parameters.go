...
// WithFilter adds the filter to the list config params
func (o *ListConfigParams) WithFilter(filter *string) *ListConfigParams {
	o.SetFilter(filter)
	return o
}

// SetFilter adds the filter to the list config params
func (o *ListConfigParams) SetFilter(filter *string) {
	o.Filter = filter
}

// WithLimit adds the limit to the list config params
func (o *ListConfigParams) WithLimit(limit *int64) *ListConfigParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the list config params
func (o *ListConfigParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithOffset adds the offset to the list config params
func (o *ListConfigParams) WithOffset(offset *int64) *ListConfigParams {
	o.SetOffset(offset)
	return o
}

// SetOffset adds the offset to the list config params
func (o *ListConfigParams) SetOffset(offset *int64) {
	o.Offset = offset
}

...
for the update config type operation typically these are written to a http.Request
*/
...
func (o *UpdateConfigTypeParams) WithBody(body *models.ConfigTypeUpdate) *UpdateConfigTypeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update config type params
func (o *UpdateConfigTypeParams) SetBody(body *models.ConfigTypeUpdate) {
	o.Body = body
}

// WithID adds the id to the update config type params
func (o *UpdateConfigTypeParams) WithID(id strfmt.UUID) *UpdateConfigTypeParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update config type params
func (o *UpdateConfigTypeParams) SetID(id strfmt.UUID) {
	o.ID = id
}

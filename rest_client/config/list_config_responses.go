...
func (o *ListConfigOK) Error() string {
	return fmt.Sprintf("[GET /configs][%d] listConfigOK  %+v", 200, o.Payload)
}

func (o *ListConfigOK) GetPayload() *rest_model.ListConfigsEnvelope {
	return o.Payload
}
...
func (o *ListConfigUnauthorized) Error() string {
	return fmt.Sprintf("[GET /configs][%d] listConfigUnauthorized  %+v", 401, o.Payload)
}

func (o *ListConfigUnauthorized) GetPayload() *rest_model.APIErrorEnvelope {
	return o.Payload
}

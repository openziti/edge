...
func (o *PatchServiceParams) WithBody(body *models.ServicePatch) *PatchServiceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the patch service params
func (o *PatchServiceParams) SetBody(body *models.ServicePatch) {
	o.Body = body
}

// WithID adds the id to the patch service params
func (o *PatchServiceParams) WithID(id strfmt.UUID) *PatchServiceParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the patch service params
func (o *PatchServiceParams) SetID(id strfmt.UUID) {
	o.ID = id
}

...
func (o *UpdateServiceParams) WithBody(body *models.ServiceUpdate) *UpdateServiceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update service params
func (o *UpdateServiceParams) SetBody(body *models.ServiceUpdate) {
	o.Body = body
}

// WithID adds the id to the update service params
func (o *UpdateServiceParams) WithID(id strfmt.UUID) *UpdateServiceParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update service params
func (o *UpdateServiceParams) SetID(id strfmt.UUID) {
	o.ID = id
}

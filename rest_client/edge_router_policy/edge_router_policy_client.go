...
type ClientService interface {
	GetEdgeRouterPoliciesIDEdgeRouters(params *GetEdgeRouterPoliciesIDEdgeRoutersParams) (*GetEdgeRouterPoliciesIDEdgeRoutersOK, error)

	GetEdgeRouterPoliciesIDIdentities(params *GetEdgeRouterPoliciesIDIdentitiesParams) (*GetEdgeRouterPoliciesIDIdentitiesOK, error)

	CreateEdgeRouterPolicy(params *CreateEdgeRouterPolicyParams, authInfo runtime.ClientAuthInfoWriter) (*CreateEdgeRouterPolicyOK, error)
...
/*
  GetEdgeRouterPoliciesIDEdgeRouters lists edge routers a policy affects
...
*/
func (a *Client) GetEdgeRouterPoliciesIDEdgeRouters(params *GetEdgeRouterPoliciesIDEdgeRoutersParams) (*GetEdgeRouterPoliciesIDEdgeRoutersOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetEdgeRouterPoliciesIDEdgeRoutersParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "GetEdgeRouterPoliciesIDEdgeRouters",
		Method:             "GET",
		...
		Params:             params,
		Reader:             &GetEdgeRouterPoliciesIDEdgeRoutersReader{formats: a.formats},
	...
	success, ok := result.(*GetEdgeRouterPoliciesIDEdgeRoutersOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetEdgeRouterPoliciesIDEdgeRouters: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
  GetEdgeRouterPoliciesIDIdentities lists identities an edge router policy affects
...
*/
func (a *Client) GetEdgeRouterPoliciesIDIdentities(params *GetEdgeRouterPoliciesIDIdentitiesParams) (*GetEdgeRouterPoliciesIDIdentitiesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetEdgeRouterPoliciesIDIdentitiesParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "GetEdgeRouterPoliciesIDIdentities",
		Method:             "GET",
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetEdgeRouterPoliciesIDIdentitiesReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	success, ok := result.(*GetEdgeRouterPoliciesIDIdentitiesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetEdgeRouterPoliciesIDIdentities: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
*/
func (a *Client) CreateEdgeRouterPolicy(params *CreateEdgeRouterPolicyParams, authInfo runtime.ClientAuthInfoWriter) (*CreateEdgeRouterPolicyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	success, ok := result.(*CreateEdgeRouterPolicyOK)
	if ok {
		return success, nil
	}
	// unexpected success response

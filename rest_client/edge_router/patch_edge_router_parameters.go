...
for the patch edge router operation typically these are written to a http.Request
*/
...
func (o *PatchEdgeRouterParams) WithBody(body *models.EdgeRouterPatch) *PatchEdgeRouterParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the patch edge router params
func (o *PatchEdgeRouterParams) SetBody(body *models.EdgeRouterPatch) {
	o.Body = body
}

// WithID adds the id to the patch edge router params
func (o *PatchEdgeRouterParams) WithID(id strfmt.UUID) *PatchEdgeRouterParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the patch edge router params
func (o *PatchEdgeRouterParams) SetID(id strfmt.UUID) {
	o.ID = id
}

...
func (o *UpdateEdgeRouterParams) WithBody(body *models.EdgeRouterUpdate) *UpdateEdgeRouterParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update edge router params
func (o *UpdateEdgeRouterParams) SetBody(body *models.EdgeRouterUpdate) {
	o.Body = body
}

// WithID adds the id to the update edge router params
func (o *UpdateEdgeRouterParams) WithID(id strfmt.UUID) *UpdateEdgeRouterParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update edge router params
func (o *UpdateEdgeRouterParams) SetID(id strfmt.UUID) {
	o.ID = id
}

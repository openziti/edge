...
func (o *UpdateIdentityParams) WithBody(body *models.IdentityUpdate) *UpdateIdentityParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update identity params
func (o *UpdateIdentityParams) SetBody(body *models.IdentityUpdate) {
	o.Body = body
}

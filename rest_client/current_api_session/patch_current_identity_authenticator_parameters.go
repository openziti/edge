...
func (o *PatchCurrentIdentityAuthenticatorParams) WithBody(body *models.AuthenticatorPatch) *PatchCurrentIdentityAuthenticatorParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the patch current identity authenticator params
func (o *PatchCurrentIdentityAuthenticatorParams) SetBody(body *models.AuthenticatorPatch) {
	o.Body = body
}

// WithID adds the id to the patch current identity authenticator params
func (o *PatchCurrentIdentityAuthenticatorParams) WithID(id strfmt.UUID) *PatchCurrentIdentityAuthenticatorParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the patch current identity authenticator params
func (o *PatchCurrentIdentityAuthenticatorParams) SetID(id strfmt.UUID) {
	o.ID = id
}

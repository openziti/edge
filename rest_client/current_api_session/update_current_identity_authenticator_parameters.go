...
func (o *UpdateCurrentIdentityAuthenticatorParams) WithBody(body *models.AuthenticatorUpdate) *UpdateCurrentIdentityAuthenticatorParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update current identity authenticator params
func (o *UpdateCurrentIdentityAuthenticatorParams) SetBody(body *models.AuthenticatorUpdate) {
	o.Body = body
}

// WithID adds the id to the update current identity authenticator params
func (o *UpdateCurrentIdentityAuthenticatorParams) WithID(id strfmt.UUID) *UpdateCurrentIdentityAuthenticatorParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update current identity authenticator params
func (o *UpdateCurrentIdentityAuthenticatorParams) SetID(id strfmt.UUID) {
	o.ID = id
}

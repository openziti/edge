...
for the delete c a operation typically these are written to a http.Request
*/
...
// WithTimeout adds the timeout to the delete c a params
func (o *DeleteCAParams) WithTimeout(timeout time.Duration) *DeleteCAParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the delete c a params
func (o *DeleteCAParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the delete c a params
func (o *DeleteCAParams) WithContext(ctx context.Context) *DeleteCAParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete c a params
func (o *DeleteCAParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete c a params
func (o *DeleteCAParams) WithHTTPClient(client *http.Client) *DeleteCAParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the delete c a params
func (o *DeleteCAParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithID adds the id to the delete c a params
func (o *DeleteCAParams) WithID(id strfmt.UUID) *DeleteCAParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete c a params
func (o *DeleteCAParams) SetID(id strfmt.UUID) {
	o.ID = id
}

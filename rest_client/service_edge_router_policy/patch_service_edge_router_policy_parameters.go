...
type PatchServiceEdgeRouterPolicyParams struct {
	...
	*/
	Body *models.ServiceEdgePolicyPatch
	/*ID
...
func (o *PatchServiceEdgeRouterPolicyParams) WithBody(body *models.ServiceEdgePolicyPatch) *PatchServiceEdgeRouterPolicyParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the patch service edge router policy params
func (o *PatchServiceEdgeRouterPolicyParams) SetBody(body *models.ServiceEdgePolicyPatch) {
	o.Body = body
}

// WithID adds the id to the patch service edge router policy params
func (o *PatchServiceEdgeRouterPolicyParams) WithID(id strfmt.UUID) *PatchServiceEdgeRouterPolicyParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the patch service edge router policy params
func (o *PatchServiceEdgeRouterPolicyParams) SetID(id strfmt.UUID) {
	o.ID = id
}

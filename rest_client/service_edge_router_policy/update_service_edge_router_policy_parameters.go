...
type UpdateServiceEdgeRouterPolicyParams struct {
	...
	*/
	Body *models.ServiceEdgePolicyUpdate
	/*ID
...
func (o *UpdateServiceEdgeRouterPolicyParams) WithBody(body *models.ServiceEdgePolicyUpdate) *UpdateServiceEdgeRouterPolicyParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update service edge router policy params
func (o *UpdateServiceEdgeRouterPolicyParams) SetBody(body *models.ServiceEdgePolicyUpdate) {
	o.Body = body
}

// WithID adds the id to the update service edge router policy params
func (o *UpdateServiceEdgeRouterPolicyParams) WithID(id strfmt.UUID) *UpdateServiceEdgeRouterPolicyParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update service edge router policy params
func (o *UpdateServiceEdgeRouterPolicyParams) SetID(id strfmt.UUID) {
	o.ID = id
}

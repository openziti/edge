...
type ListTransitRoutersEnvelope struct {
	...
	// data
	Data TransitRouterList `json:"data,omitempty"`
...
func (m *ListTransitRoutersEnvelope) validateData(formats strfmt.Registry) error {
...
func (m *ListTransitRoutersEnvelope) validateMeta(formats strfmt.Registry) error {
...
func (m *ListTransitRoutersEnvelope) UnmarshalBinary(b []byte) error {
	var res ListTransitRoutersEnvelope

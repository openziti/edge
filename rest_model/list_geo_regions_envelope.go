...
type ListGeoRegionsEnvelope struct {
	...
	// data
	Data GeoRegionList `json:"data,omitempty"`
...
func (m *ListGeoRegionsEnvelope) validateData(formats strfmt.Registry) error {
...
func (m *ListGeoRegionsEnvelope) validateMeta(formats strfmt.Registry) error {
...
func (m *ListGeoRegionsEnvelope) UnmarshalBinary(b []byte) error {
	var res ListGeoRegionsEnvelope

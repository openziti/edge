...
type DetailGeoRegionEnvelope struct {
	...
	// data
	Data *GeoRegionDetail `json:"data,omitempty"`
...
func (m *DetailGeoRegionEnvelope) validateData(formats strfmt.Registry) error {
...
func (m *DetailGeoRegionEnvelope) validateMeta(formats strfmt.Registry) error {
...
func (m *DetailGeoRegionEnvelope) UnmarshalBinary(b []byte) error {
	var res DetailGeoRegionEnvelope
